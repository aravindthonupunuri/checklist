...
class GrafanaBuilderRegistryChecklistsConsumerUnitTest extends Specification {
    ...
    def "build backpack-registry-checklists-consumer-app grafana dashboard"() {
        ...
        def metricsAlert = new GrafanaBuilderConfig.MetricsAlert(
            prodTapApplication: "backpackregistrychecklistsconsumer",
            prodTapCluster: "backpackregistrychecklistsconsumer",
        ...
        def kafkaConsumers = [
            new GrafanaBuilderConfig.KafkaConsumer(
                title: "Registry Checklists Consumer",
                ...
                devEnvironment: new GrafanaBuilderConfig.KafkaConsumerEnvironment(
                    ...
                    consumerGroup: "backpack-registrychecklists-con-msg-bus-consumer",
                ...
                stageEnvironment: new GrafanaBuilderConfig.KafkaConsumerEnvironment(
                    ...
                    consumerGroup: "backpack-registrychecklists-con-data-bus-stage-consumer",
                    ttcCluster: "ost-ttc-test-app",
                    tteCluster: "ost-ttce-test-app"
                ),
            ...
            new GrafanaBuilderConfig.KafkaConsumer(
                title: "Registry Checklists DLQ Consumer",
                metricsName: "msgbus_consumer_event",
                isDlqConsumer: true,
                devEnvironment: new GrafanaBuilderConfig.KafkaConsumerEnvironment(
                    topic: "registry-internal-data-bus-dev-dlq",
                    consumerGroup: "backpack-registrychecklists-con-dlq-consumer",
                    ttcCluster: "ost-ttc-test-app",
                    tteCluster: "ost-ttce-test-app"
                ),
                stageEnvironment: new GrafanaBuilderConfig.KafkaConsumerEnvironment(
                    topic: "registry-internal-data-bus-stage-dlq",
                    consumerGroup: "backpack-registrychecklists-con-dlq-stage-consumer",
                    ttcCluster: "ost-ttc-test-app",
                    tteCluster: "ost-ttce-test-app"
                ),
                prodEnvironment: new GrafanaBuilderConfig.KafkaConsumerEnvironment(
        ...
        def kafkaProducers = [
            new GrafanaBuilderConfig.KafkaProducer(
                title: "Registry Checklists msgbus DLQ Producer",
