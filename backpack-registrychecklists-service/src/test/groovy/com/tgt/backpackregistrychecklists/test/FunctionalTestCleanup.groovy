...
That file should contain a single line pointing to this extension as com.tgt.backpackregistryservice.test.FunctionalTestCleanup
 */
...
class FunctionalTestCleanup extends AbstractGlobalExtension {
    ...
    void stop() {
        ...
        if (BasePersistenceFunctionalTest.postgreSQLContainer != null) {
            ...
            BasePersistenceFunctionalTest.postgreSQLContainer.stop()
        }
    }
}
