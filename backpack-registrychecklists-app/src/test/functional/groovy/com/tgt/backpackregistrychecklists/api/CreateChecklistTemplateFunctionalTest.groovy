...
class CreateChecklistTemplateFunctionalTest extends BasePersistenceFunctionalTest {
    ...
    def setupSpec() {
        ...
        file.append("<l2_taxonomy_url>/c/travel-systems-strollers-baby/-/N-5xtjw</l2_taxonomy_url>\n")
    ...
    def "test create checklist integrity"() {
        given:
        String guestId = "1236"
        String uri = "registries_checklists/v1/checklist_templates?registry_type=BABY&template_id=1&channel=web&sub_channel=TGTWEB&checklist_name=checklistname1"
    ...
    def "test create checklist checklisttemplate table already have that templateid"() {
        given:
        String guestId = "1236"
        String uri = "registries_checklists/v1/checklist_templates?registry_type=WEDDING&template_id=91&channel=web&sub_channel=TGTWEB&checklist_name=checklistname12"
    ...
    def "test create checklist checklisttemplate table  already have that registryType"() {
        given:
        String guestId = "1236"
        String uri = "registries_checklists/v1/checklist_templates?registry_type=BABY&template_id=2&channel=web&sub_channel=TGTWEB&checklist_name=checklistname13"
    ...
    def "test create checklist checklisttemplate table  already have that checklist name for the templateId which we are going to update"() {
        given:
        String guestId = "1236"
        String uri = "registries_checklists/v1/checklist_templates?registry_type=BABY&template_id=7&channel=web&sub_channel=TGTWEB&checklist_name=checklistName"
    ...
    def "test create checklist checklisttemplate table  already have that checklist name for a different"() {
        given:
        String guestId = "1236"
        String uri = "registries_checklists/v1/checklist_templates?registry_type=BABY&template_id=6&channel=web&sub_channel=TGTWEB&checklist_name=checklistName"
